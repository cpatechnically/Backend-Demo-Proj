...
ALLOWED_HOSTS = [
    "simpledemos-app.herokuapp.com",
    "https://simpledemos-app.herokuapp.com",
    ".simpledemos-app.herokuapp.com",
    "www.simpledemos-app.herokuapp.com/",
]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'my_static'),   #What our static file folder is named
]
...
if not DEBUG:
    from cap.static_srv.production import *

    if LINODE_BUCKET:
        print(f"\nLINODE_BUCKET IS PRESENT!!! ->{LINODE_BUCKET} \nSetting for {MODULE} static -> {LINODE_BUCKET} \n linode key{LINODE_BUCKET_ACCESS_KEY != None} \nLINODE_BUCKET_SECRET_KEY -> {LINODE_BUCKET_SECRET_KEY != None} \n\n{DATABASES['default']} \nALLOWED_HOSTS {ALLOWED_HOSTS}")
